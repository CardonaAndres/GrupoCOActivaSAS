...
import { Target, Shield, Users, Linkedin, Instagram } from 'lucide-react';
                ...
                <div className="p-8 md:p-12">
                  ...
                  <div className='flex items-center gap-3'>
                    <a
                      ...
                      aria-label="LinkedIn de Esteban Restrepo"
                      className="inline-flex items-center gap-2 bg-cyan-700 hover:bg-cyan-800 text-white px-5 py-3 rounded-lg font-semibold transition-colors shadow-md text-sm"
                    >
                      <Linkedin className="w-4 h-4" />
                      LinkedIn
                    </a>

                    <a href="https://www.instagram.com/estebanrlegal"
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="Instagram de Esteban Restrepo"
                      className="inline-flex items-center gap-2 bg-cyan-700 text-white px-5 py-3 rounded-lg font-semibold transition-all shadow-md text-sm"
                    >
