...
export const LocationsComponent: React.FC<LocationsComponentProps> = ({ styles }) => {
  ...
  const handleMoreInfo = () => window.location.href = currentLocation.route;
    ...
    >
      ...
      <div className="p-4 bg-gray-50 border-t border-gray-100">
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className={`w-full flex items-center justify-center space-x-2 px-4 py-3 rounded-lg font-medium transition-all duration-200 ${styles.text.primary} bg-white border-2 border-blue-200 hover:bg-blue-50 hover:border-blue-300`}
        >
