        ...
        >
            <div className="mb-8">
                <motion.p 
                    ...
                    className="text-teal-800/80 text-sm font-bold tracking-wider uppercase mb-4"
                >
                    Nuestros Clientes
                </motion.p>
            </div>
            ...
            <div className="relative overflow-hidden py-8">
                ...
                >
                    ...
                    {[...brands, ...brands].map((brand, index) => (
                        <div 
                            key={`brand-${index}`} 
                            className="flex-shrink-0 group px-4 sm:px-8 md:px-12"
                        >
                            <div className="w-28 h-20 sm:w-36 sm:h-24 md:w-44 md:h-28 flex items-center justify-center">
                                <img 
                                    src={brand.logo} 
                                    alt={brand.name}
                ...
                {/* Gradientes sutiles en los bordes - ajustados para móvil */}
                <div className="absolute inset-y-0 left-0 w-12 sm:w-20 md:w-32 
                              bg-gradient-to-r from-white via-white/80 to-transparent 
                              pointer-events-none z-10" />
                <div className="absolute inset-y-0 right-0 w-12 sm:w-20 md:w-32 
            ...
            >
                ...
                <div className="w-px h-8 sm:h-12 bg-teal-800/30"></div>
                <div className="text-center">
